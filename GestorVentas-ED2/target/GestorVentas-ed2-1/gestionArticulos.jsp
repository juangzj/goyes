        ...
        <table class="table table-striped" style="width: 100%; margin: auto;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 10px; text-align: center;"><img src="data:image/png;base64,<%=imagenBase64%>" style="max-width: 100px; max-height: 80px; object-fit: cover;" /></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="SvAniadirArticulo" method="POST" enctype="multipart/form-data" > 
                    <div class="mb-3">
